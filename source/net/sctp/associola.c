        ...
        gfp_t gfp)
{
    ...
    sctp_inq_set_th_handler(&asoc->base.inqueue, sctp_assoc_bh_rcv); // sctp_mark
...
struct sctp_transport *sctp_assoc_is_match(struct sctp_association *asoc, //sctp_mark Å¼ÁªÆ¥Åä
        ...
        const union sctp_addr *paddr)
{
            ...
            (htons(asoc->peer.port) == paddr->v4.sin_port))
    {
        ...
        if (sctp_bind_addr_match(&asoc->base.bind_addr, laddr, sctp_sk(asoc->base.sk)))
            goto out;
    }
