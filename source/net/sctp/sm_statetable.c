...
const sctp_sm_table_entry_t *sctp_sm_lookup_event(sctp_event_t event_type, // 事件类型
        sctp_state_t state,  // 状态机状态
        sctp_subtype_t event_subtype) // chunk type
{
    switch (event_type) {
 ...
 */
static const sctp_sm_table_entry_t chunk_event_table[SCTP_NUM_BASE_CHUNK_TYPES][SCTP_STATE_NUM_STATES] =  // [chunk type][states]
{
    TYPE_SCTP_DATA,
    TYPE_SCTP_INIT,
    TYPE_SCTP_INIT_ACK,
