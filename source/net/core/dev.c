...
static int __net_init netdev_init(struct net *net)
{
    ...
    net->dev_name_head = netdev_create_hash();  // 以设备名称为主键的哈希队列
    if (net->dev_name_head == NULL)
        goto err_name;

    net->dev_index_head = netdev_create_hash(); // 以设备序号为主键的哈希队列
...
subsys_initcall(net_dev_init);  //lgx_mark init_net 初始化
